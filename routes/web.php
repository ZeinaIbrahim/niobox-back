...
// Route::get('dashboard', [SystemController::class, 'dashboard'])->name('frontend-dashboard')->middleware(FrontMiddleware::class);
// Route::get('store', [SystemController::class, 'store'])->name('frontend-store');

// Route::get('product/{id}', [SystemController::class, 'product'])->name('frontend-product');
